...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_tkl_ansi(
        _______,            MI_CH1 ,  MI_CH2 ,  MI_CH3 ,  MI_CH4 ,  MI_CH5 ,  MI_CH6 ,  MI_CH7 ,  MI_CH8 ,  MI_CH9 ,  MI_CH10,  MI_CH11,    MI_CH12,  _______,  _______,  _______,
        _______,  _______,  MI_Cs1 ,  MI_Ds1 ,  _______,  MI_Fs1 ,  MI_Gs1 ,  MI_As1 ,  _______,  MI_Cs2 ,  MI_Ds2 ,  _______,  _______,    _______,  _______,  _______,  MI_OCTU,
        _______,  MI_C1  ,  MI_D1  ,  MI_E1  ,  MI_F1  ,  MI_G1  ,  MI_A1  ,  MI_B1  ,  MI_C2  ,  MI_D2  ,  MI_E2  ,  _______,  _______,    _______,  _______,  _______,  MI_OCTD,
        _______,  _______,  MI_Cs  ,  MI_Ds  ,  _______,  MI_Fs  ,  MI_Gs  ,  MI_As  ,  _______,  MI_Cs1 ,  MI_Ds1 ,  _______,            _______,
        _______,            MI_C   ,  MI_D   ,  MI_E   ,  MI_F   ,  MI_G   ,  MI_A   ,  MI_B   ,  MI_C1  ,  MI_D1  ,  MI_E1  ,              _______,            MI_BNDU,
        _______,  _______,  _______,                                MI_SUST,                                _______,  MO(MAC_FN),  _______,    _______,  MI_VELD,  MI_BNDD,  MI_VELU),
    // [MAC_BASE] = LAYOUT_tkl_ansi(
    ...
    [WIN_FN] = LAYOUT_tkl_ansi(
        ...
        _______,  _______,  MI_Cs1 ,  MI_Ds1 ,  _______,  MI_Fs1 ,  MI_Gs1 ,  MI_As1 ,  _______,  MI_Cs2 ,  MI_Ds2 ,  _______,  _______,    _______,  _______,  _______,  MI_OCTU,
        _______,  MI_C1  ,  MI_D1  ,  MI_E1  ,  MI_F1  ,  MI_G1  ,  MI_A1  ,  MI_B1  ,  MI_C2  ,  MI_D2  ,  MI_E2  ,  _______,  _______,    _______,  _______,  _______,  MI_OCTD,
        KC_OSSW,  _______,  MI_Cs  ,  MI_Ds  ,  _______,  MI_Fs  ,  MI_Gs  ,  MI_As  ,  _______,  MI_Cs1 ,  MI_Ds1 ,  _______,            _______,
        _______,            MI_C   ,  MI_D   ,  MI_E   ,  MI_F   ,  MI_G   ,  MI_A   ,  MI_B   ,  MI_C1  ,  MI_D1  ,  MI_E1  ,              _______,            MI_BNDU,
        _______,  GU_TOGG,  _______,                                MI_SUST,                                _______,  _______,  _______,    _______,  MI_VELD,  MI_BNDD,  MI_VELU),
        // _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,  _______,  _______,
        // BL_TOGG,  BL_STEP,  BL_UP,    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,  _______,  _______,
